...
the results can be verified at [NIST- ADVANCED ENCRYPTION STANDARD](https://nvlpubs.nist.gov/nistpubs/fips/nist.fips.197.pdf) by the matrices at page 33 of of the second column.
